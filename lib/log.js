...
module.exports = function(name, silent) {
	...
	function createFactory() {
		...
		if (silent) return function(name){return Utils.extend({name: name}, nopLog)}
		try {return require('ulog')}
		catch(e) {return function(name) {return Utils.extend({name: name}, con, {trace:nop, debug:nop, log:nop})}}
	}
}
