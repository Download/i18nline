var log = require('../log')('i18nline:extractors:i18n');

var recast = require('recast');
var extend = require('extend');

var TranslateCall = require('./translate_call');
var CallHelpers = require('../call_helpers');
var TranslationHash = require('./translation_hash');
...
extend(I18nJsExtractor.prototype, CallHelpers);
...
I18nJsExtractor.prototype.run = function() {
  ...
  var ast = this.ast || recast.parse(this.source, I18nline.config.recastOptions);
  var self = this;
  recast.visit(ast, {
